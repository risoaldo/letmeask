...
export function Room() {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    if (!user) {
      alert('É necessário estar logado para enviar mensagem!');
      return;
    }
          ...
          <div className="form-footer">
            {user ?
              <div className="user-info">
                <img src={user.avatar} alt="perfil do usuario" />
                <span> {user.name} </span>
              </div>
              : <p>Para enviar uma pergunta, <button type="button" onClick={() => history.push('/')}>Faça login</button>.</p>}
